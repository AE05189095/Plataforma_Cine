  ...
  useEffect(() => {
    const fetchMovie = async () => {
      try {
        ...
        setError(err.message || "Error al obtener los datos de la película");
      } finally {
        setLoading(false);
      }
    };
                ...
                >
                  ...
                  <p className="text-lg mb-2 text-gray-300">
                    ...
                    <span className="font-semibold text-white">
                      {show.hall?.name || "Sala no especificada"}
                    </span>
                  </p>

                  <p className="mt-3 font-semibold text-2xl text-orange-400">
                    Q{show.price}
                  </p>
