...
// ⚠️ Nota: Las constantes SOCKET_URL y API_BASE se cargan desde process.env
// Asegúrate de que .env.local contenga NEXT_PUBLIC_API_URL, e.g., http://localhost:5000
...
export default function ComprarPage() {
  ...
  const updateSeatLocks = useCallback(async (seatsToLock: Seat[]) => {
    ...
    try {
      // ⚠️ ESTA RUTA DEBE EXISTIR EN EL NUEVO purchaseController (No en showtime.routes.js)
        ...
        <main className="p-8">
          <div className="max-w-6xl mx-auto">
            ...
            {loading ? (
              ...
              // 🛑 MENSAJE DE ERROR: Se muestra si showtime es NULL
